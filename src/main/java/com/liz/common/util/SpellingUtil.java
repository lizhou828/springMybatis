...
/**
 *  the tool for convert chinese to spelling, u can use like this:
 *  <pre>
 *      String chinese = "中文";
 *      String spelling = SpellingUtils.getFullSpell(chinese);
 *      // the spelling is "zhongwen"
 *  </pre>
 */
public class SpellingUtil {
    ...
    private static String getSpellByAscii(int ascii) {
        ...
        if (ascii < -20319 || ascii > -10247) {
            for (String s : otherSpellMap.keySet()) {
                Object otherValObj = otherSpellMap.get(s);
    ...
    public static String getSpelling(String cnStr) {
